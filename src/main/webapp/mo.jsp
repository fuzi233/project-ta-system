    ...
    <section class="glass card">
        ...
        <div id="panelReview" class="mo-panel active">
            <div style="display:flex; gap:.6rem; flex-wrap:wrap; margin-bottom:.75rem;">
                ...
                <input id="reviewJobSearch" list="reviewJobOptions" type="text" placeholder="Search job or candidate"/>
            ...
            <div class="filter-strip">
                <button id="filterAll" class="btn ghost" type="button">All</button>
                <button id="filterPending" class="btn ghost" type="button">Pending</button>
                <button id="filterInterviewed" class="btn ghost" type="button">Interviewed</button>
                <button id="filterAccepted" class="btn ghost" type="button">Accepted</button>
                <button id="filterRejected" class="btn ghost" type="button">Rejected</button>
            </div>
